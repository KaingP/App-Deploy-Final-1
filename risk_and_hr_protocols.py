"""
HR Management Protocols, Attendance Guidelines & Operational Risk Matrix
for Hùng Vương Concert - Project F&B.
"""
        ...
        "risks": [
            {
                "id": "R01",
                "category": "Nhân sự",
                "risk_event": "Thiếu hụt nhân sự do nhiều thành viên trùng lịch thi học kỳ hoặc ốm đột xuất",
